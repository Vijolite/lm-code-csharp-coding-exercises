...
namespace Exercises.Tests
{
    public class Exercise004Tests
    {
        ...
        [Test]
        public void AddGigaSecond_Should_Return_Result_When_DateTime_Is_Specified_New_Year_Eve()
        {
            DateTime actualResult = Exercise004.AddGigaSecond(new DateTime(2021, 12, 31, 23, 59, 59, 0));
            DateTime expectedResult = new(2053, 9, 9, 1, 46, 39);
            actualResult.Should().Be(expectedResult);
        }
